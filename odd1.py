...
from profile_marathi import save_profile
...
def window_marathi():
    ...
    def recognize_speech(target_language='mr'):
        ...
        try:
            ...
            translated_text = translator.translate(text, src='mr', dest=target_language)
    ...
    tk.Label(window1, text="नाव:", font=("Helvetica", 12), bg='#0000FF', fg='white').grid(row=1, column=0, sticky='w', padx=10, pady=10)
    name_var = tk.StringVar()
    tk.Entry(window1, textvariable=name_var, font=("Helvetica", 12)).grid(row=1, column=1, padx=10, pady=10)

    tk.Label(window1, text="वय:", font=("Helvetica", 12), bg='#0000FF', fg='white').grid(row=2, column=0, sticky='w', padx=10, pady=10)
    age_var = tk.StringVar()
    tk.Entry(window1, textvariable=age_var, font=("Helvetica", 12)).grid(row=2, column=1, padx=10, pady=10)

    tk.Label(window1, text="फोन नं:", font=("Helvetica", 12), bg='#0000FF', fg='white').grid(row=3, column=0, sticky='w', padx=10, pady=10)
    ...
    tk.Button(window1, text="नाव बोला", command=lambda: get_voice_input(name_var), font=("Helvetica", 10)).grid(row=1, column=2, padx=10, pady=10)
    tk.Button(window1, text="वय बोला", command=lambda: get_voice_input(age_var), font=("Helvetica", 10)).grid(row=2, column=2, padx=10, pady=10)
    tk.Button(window1, text="फोन नं बोला", command=lambda: get_voice_input(phone_var), font=("Helvetica", 10)).grid(row=3, column=2, padx=10, pady=10)
    ...
    start_button = ttk.Button(window1, text="माहिती जतन करा", command=save_information, style='Start.TButton')
